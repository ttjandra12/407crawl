...
const int Y1Input = 5; // Connect output Y1 to 5
const int Y2Input = 6; // Connect output Y2 to 6 
...
void loop() 
{
  ...
  for (byte pin=0; pin<=7; pin++)
  {
    ...
    int inputY1Value = digitalRead(5); // and read Y1
    int inputY2Value = digitalRead(6); // and read Y2
